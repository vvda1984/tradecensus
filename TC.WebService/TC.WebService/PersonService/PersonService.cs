    ...
    public class PersonService : TradeCensusServiceBase, IPersonService
    {
        ...
        private PersonModel GetPerson(string userName, string password)
        {
            ...
            var res = new PersonModel
            {
                ...
                HasAuditRole = person.Role % 10 == 1 || person.Role % 10 == 3 || person.Role % 10 == 4, // == Constants.RoleAudit || user.Role == Constants.RoleAudit1,
                Role = person.Role,
                IsAuditor2 = person.Role == Constants.RoleAudit2,
