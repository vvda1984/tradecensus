...
function language_en() {
  return {
    ...
    msg_validate_accuracy_1:
      "Failed to locate outlet GPS. Please try with a clear view of sky<br/>(Tín hiệu GPS yếu, vui lòng di chuyển ra khu vực thông thoáng hơn)",
