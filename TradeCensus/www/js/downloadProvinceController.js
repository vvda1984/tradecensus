...
function downloadProvinceController($scope, $mdDialog) {
  ...
  $scope.download = function (p) {
    ...
    selectUnsyncedOutletsOfProvince(
      ...
      function (dbres) {
        ...
        showConfirm(
          "Download Outlets in " + curProvince.name + "?",
          "It may take for a while!.",
          function () {
            try {
              cancelDownload = false;
              showDlg("Downloading Outlets", "please wait...", function () {
                log("****** CANCEL download");
                cancelDownload = true;
              });
              ...
              cordova.plugin.http.sendRequest(
                ...
                function (response) {
                  ...
                  var msg = "" + response.status + ":" + response.error;
                  showError(msg);
                }
              );
            } catch (ex) {
